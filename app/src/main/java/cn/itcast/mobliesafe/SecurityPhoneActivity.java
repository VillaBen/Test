...
import cn.itcast.mobliesafe.adapter.BlackContactAdapter;
import cn.itcast.mobliesafe.db.dao.BlackNumberDao;
import cn.itcast.mobliesafe.entity.BlackContactInfo;
...
public class SecurityPhoneActivity extends Activity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        mTtv_title=(TextView) findViewById(R.id.tv_title);
        ...
        mBtn_addblacknumber=(Button)findViewById(R.id.btn_addblacknumber);
        mListView = (ListView) findViewById(R.id.lv_blacknumbers);
    }
    private void initData() {
        mRl_titlebar.setBackgroundColor(getResources().getColor(R.color.bright_purple));
        mLeftImgv.setImageResource(R.drawable.back);
        mTtv_title.setText("通讯卫士");
